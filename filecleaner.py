...
# change the "nan" for businesses that do not have a latitude and longitude
df1['Location'].fillna("Not Available",inplace=True)
...
df1.columns = ['license_number','license_type','license_expiration','license_status','license_creation_date',
               'industry','business_name','phone_number','longitude','latitude','location']

# export the resulting CSV file
df1.to_csv('nyc_businesses.csv',encoding='utf-8', index=False)
